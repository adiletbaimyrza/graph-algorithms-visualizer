const pseudocodes = {
  ...
  prim: [
    ...
    { indent: 40, content: 'if (!visited.has(to)) {' },
    { indent: 60, content: 'visited.add(to)' },
    { indent: 60, content: 'for (const neighbor of graph[to]) {' },
    { indent: 80, content: 'if (!visited.has(neighbor) {' },
    {
      indent: 100,
  ...
  kruskal: [
    ...
    { indent: 20, content: 'const dijsointSet = new DisjointSet()' },
    { indent: 20, content: 'const mst = new Array()' },
    { indent: 20, content: 'edges.sort()' },
    { indent: 20, content: 'for (const edge of edges) {' },
    {
      indent: 40,
      content: 'const { vx1, vx2, weight } = edge',
    },
    { indent: 40, content: 'if (!disjointSet.isConnected(vx1, vx2)) {' },
    { indent: 60, content: 'mst.push(edge)' },
    { indent: 60, content: 'disjointSet.union(vx1, vx2)' },
    { indent: 40, content: '}' },
    { indent: 20, content: '}' },
    { indent: 0, content: '}' },
  ],
